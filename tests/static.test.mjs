...
const required = [
  ...
  'manifest.webmanifest','sw.js','icons/icon.svg','assets/branding/tmdb-logo.svg','docs/API-SOURCES.md','netlify/functions/movie-search.mjs','netlify/functions/movie-detail.mjs','netlify.toml'
];
...
assert.ok(html.includes('app.js?v=0.4.0'), 'asset cache-busting version missing');
