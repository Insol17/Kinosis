...
assert.ok(html.includes('<script type="module" src="./assets/js/app.js?v=0.4.5.4"></script>'), 'browser entry must be a native ES module');
for (const legacy of ['features/search.js?v=0.4.5.4"></script>','core/movie-entities.js?v=0.4.5.4"></script>','services/movie-loader.js?v=0.4.5.4"></script>','features/detail.js?v=0.4.5.4"></script>']) assert.ok(!html.includes(`<script src="./assets/js/${legacy}`), `critical module still loaded as ordered global script: ${legacy}`);
