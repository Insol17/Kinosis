# Netlify deployment — KINOSIS 0.4.6.6
...
The 0.4.5.4 Studio migration adds lightweight list metadata so the Studio home does not download every full Director snapshot.
