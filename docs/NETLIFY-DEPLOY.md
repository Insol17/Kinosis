# Netlify deployment — KINOSIS 0.4.5.8
...
The 0.4.5.8 migration adds lightweight Studio list metadata so the Studio home does not download every full Director snapshot.
